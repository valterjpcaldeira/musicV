$(function () {
    ...
    function printMessage(mensagem){
        ...
        var html = '<div class="message-block"><div class="message out"><span>' + mensagem.text + '</span><span class="time">' + mensagem.time + '</span><span class="auth">' + mensagem.auth + '</span></div></div>';
        $(html).insertBefore($('#chatbot .chat-wrapper .message-waiting'));
